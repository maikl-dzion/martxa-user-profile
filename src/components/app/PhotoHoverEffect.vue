<template>
<div v-if="image1" class="product-grid">
  <div class="product-image">
    <a >
      <img class="pic-1" :src="image1" style="width: 100%">
      <img v-if="image2" class="pic-2"  :src="image2">
      <img v-else class="pic-2"  :src="image1">
    </a>
    <span class="product-trend-label">{{title}}</span>
