  ...
  <PageTemplate>
    ...
    <div style="">
      ...
      <div style="display: flex">
        ...
        <img src="/assets/images/fon/fon-6.jpg" alt="" style="position: relative; margin-bottom: 20px; width: 60%">
        ...
        <div class="universal_component_wrapper universal_component_wrapper_tablet_block"
          ...
          <div class="universal_component_content universal_component_content_3_4">
            ...
            <div>Статья позаимствована с сайта <a href="https://web-creator.ru/articles/solid">https://web-creator.ru/articles/solid</a>
            </div>
      ...
      <div style="display: flex">
        ...
        <div class="html_text content is-paddingless" style="width: 40%"><p class="accent">Принцип инверсии зависимостей — The&nbsp;Dependency
        ...
        <img src="/assets/images/fon/fon-14.jpg" style="width: 60%;position: relative; margin-bottom: 20px; margin-left: 20px;">
